		 ...
		 <div class="registration_left">
			 ...
			 <!-- Form -->
				<form action="app.php" method="get">
					<div>
						<label>
							<input placeholder="first name" type="text" tabindex="1" value="">
						</label>
					</div>
					<div>
						<label>
							<input placeholder="last name" type="text" tabindex="2" value="">
						</label>
					</div>
					<div>
						<label>
							<input placeholder="email address" type="email" tabindex="3" value="">
						</label>
					</div>
					<div>
						<label>
							<input placeholder="Mobile" type="email" tabindex="3" value="">
						</label>
					</div>					
						<div class="sky_form1">
							<ul>
					...
					<div>
						<label>
							<input placeholder="password" type="password" tabindex="4" value="">
						</label>
					</div>						
					<div>
						<label>
							<input placeholder="retype password" type="password" tabindex="4" value="">
						</label>
					</div>	
					<div>
